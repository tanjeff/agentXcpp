...
namespace agentxcpp
{
     ...
     * provided by the user or generated automatically. There are two 
     * constructors available therefore. The used object (whether auto-generaed 
     * or not) can be obtained using the get_io_service() function. If the 
     * io_service object was autogenerated by the constructor, it will be 
     ...
     * objects using the same io_service object.
     *
     * \internal
