...
namespace agentxcpp
{
    ...
    class Counter32Variable : public AbstractVariable
    {
        ...
        public:
             ...
             */
            virtual testset_result_t testset(QSharedPointer<Counter32Variable> _v)
            {
                return noAccess;
            }
             ...
             * \param _v The new value for the object.
             */
            virtual void cleanupset(QSharedPointer<Counter32Variable> _v)
            {
                return;
            }
             ...
             */
            virtual bool commitset(QSharedPointer<Counter32Variable> _v)
            {
                return false;
            }
             ...
             */
            virtual bool undoset(QSharedPointer<Counter32Variable> _v)
            {
                return false;
            }
